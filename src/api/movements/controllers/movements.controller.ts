...
export class MovementsController {
  ...
  @ApiResponse({
    ...
    description:
      "Les données de synchronisation ne sont pas valide à cause d'un doublon ou un manquant",
    schema: {
  ...
  validateMovements(
    @Body() movements: ValidateMovementsRequestDto,
  ): any | MovementAcceptedResponse {
